...
def gen_func_body(prop, inp, expected):
    ...
    if prop == "modifier":
        ...
        str_list.append("100, 400, 1000, 2100, 3800, 6200, 9100, 12200,")
        str_list.append("14800, 16700, 17200, 16000, 13100, 9400, 5400, 2100")
        str_list.append("};\n\n")
        str_list.append("double results[16] = " + "{0};\n")
        str_list.append("for (size_t i = 0; i < 129600; ++i) " + "{\n")
