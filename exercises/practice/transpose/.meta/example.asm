...
.find_longest_string_length:
    ...
    xor r9d, r9d
.find_end:
    pcmpistri xmm1, oword [rbx + r9], 0b00_10_10_00 ; finds the index of first char equal to its corresponding byte in xmm1, and returns it in ecx
                                               ; since xmm1 is empty, it returns the index of NUL, or 16 if NUL was not found
    add r9d, ecx                               ; accumulate total length for row
    cmp ecx, 16
    jz .find_end                               ; continue looping until NUL is found
