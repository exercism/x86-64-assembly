...
;
; The allocator function should be called with the capacity as argument and returns the address of the allocated space.
; This space has undefined value and should be cleared.
;
; The 'create_month_list' function should return the address for the allocated space.
